return {
    ...
    config = function()
     vim.api.nvim_create_autocmd('LspAttach', {
      ...
      -- Mason keymaps
      vim.keymap.set('n', '<leader>lm', '<cmd>Mason<cr>', { desc = '[L]SP [M]ason' })
        ...
        gopls = {
          settings = {
            gopls = {
              ...
              codelenses = {
                test = true, tidy = true, vendor = true, generate = true,
                regenerate_cgo = true, gc_details = true, upgrade_dependency = true,
              },
            },
          },
        },
