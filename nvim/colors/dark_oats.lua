...
set(0, "Special", { fg = c.fg })
set(0, "Title", { fg = c.white, bold = true })
set(0, "Directory", { fg = c.fg })

set(0, "DiagnosticError", { fg = c.fg_soft })
set(0, "DiagnosticWarn", { fg = c.fg })
set(0, "DiagnosticInfo", { fg = c.fg })
set(0, "DiagnosticHint", { fg = c.subtle })
set(0, "DiagnosticUnderlineError", { undercurl = true, sp = c.fg_soft })
set(0, "DiagnosticUnderlineWarn", { undercurl = true, sp = c.fg })
set(0, "DiagnosticUnderlineInfo", { undercurl = true, sp = c.fg })
...
set(0, "NeoTreeDirectoryIcon", { fg = c.fg })
set(0, "NeoTreeFileName", { fg = c.fg_soft })
set(0, "NeoTreeFileNameIcon", { fg = c.fg })
set(0, "NeoTreeFileNameOpened", { fg = c.fg })
set(0, "NeoTreeIndentMarker", { fg = c.border })
set(0, "NeoTreeExpander", { fg = c.fg_hard })
set(0, "NeoTreeDotfile", { fg = c.fg })
set(0, "NeoTreeGitAdded", { fg = c.fg })
set(0, "NeoTreeGitDeleted", { fg = c.fg })
set(0, "NeoTreeGitModified", { fg = c.fg })
set(0, "NeoTreeGitConflict", { fg = c.fg })
set(0, "NeoTreeGitUntracked", { fg = c.fg })
set(0, "NeoTreeGitIgnored", { fg = c.fg_hard })
set(0, "BufferLineFill", { fg = c.fg_hard, bg = c.bg_panel })
set(0, "BufferLineBackground", { fg = c.subtle, bg = c.bg_panel })
set(0, "BufferLineBufferVisible", { fg = c.fg, bg = c.bg_alt })
...
set(0, "BufferLineModified", { fg = c.fg, bg = c.bg_panel })
...
set(0, "LualineInactive", { fg = c.fg, bg = c.bg_panel })

-- Telescope (file name + path styling)
set(0, "TelescopeResultsIdentifier", { fg = c.fg_soft }) -- filename
set(0, "TelescopeResultsComment", { fg = c.fg_hard })    -- path / metadata
set(0, "TelescopeSelection", { fg = c.white, bg = c.bg_alt, bold = true })
set(0, "TelescopeSelectionCaret", { fg = c.fg_soft, bg = c.bg_alt })
set(0, "TelescopeMatching", { fg = c.white, bold = true })
